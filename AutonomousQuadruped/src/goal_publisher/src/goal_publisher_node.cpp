...
public:
  GoalPublisherNode() : ac_("move_base", true), current_goal_index_(0), tolerance_(0.25) {
...
private:
  void initializeGoals() {
    ...
    goals_.emplace_back(createGoal(0.4, 1.75, 0.0));
    goals_.emplace_back(createGoal(3.28, 1.7, 0.0));
    goals_.emplace_back(createGoal(4.21, 0.56, 0.0));
